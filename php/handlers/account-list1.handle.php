...
*/
    ...
    $query = "SELECT account_id, account_name, account_isAdmin, account_isDisqualified, account_finalScore
        FROM accounts LIMIT ?";
        ...
        if(mysqli_stmt_execute($statement)){
            ...
            if(mysqli_stmt_num_rows($statement) > 0){
                mysqli_stmt_bind_result($statement, 
                    $account_id, $account_name, $account_isAdmin, $account_isDisqualified, $account_finalScore);
                ...
                while($row = mysqli_stmt_fetch($statement)){
                    $account = (object)[
                        ...
                        "account_finalScore" => $account_finalScore,
                    ];
